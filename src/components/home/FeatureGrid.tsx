...
export default function FeatureGrid() {
  ...
  return (
    <section ref={gridRef} className="min-h-screen flex items-center justify-center bg-[var(--background)] relative z-10 py-20 overflow-hidden">
      {/* 4. GSD UX: Parallax Spatial Depth blobs */}
      ...
      <div className="text-center px-4 w-full max-w-5xl mx-auto relative z-10">
        ...
        {/* 5. GSD UX: Search-First Navigation */}
        <div className="max-w-2xl mx-auto mb-16 relative">
          <input 
            type="text" 
            placeholder="What are you looking for your little one today?" 
            className="w-full py-4 pl-6 pr-14 text-lg rounded-full border-2 border-[var(--primary)] shadow-glass-colored focus:outline-none focus:ring-4 focus:ring-[var(--primary-hover)]/30 transition-all text-[var(--foreground)]"
          />
        ...
        {/* 2. GSD UX: Atomic Product Discovery Cards with Isometric Hover */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="feature-card glass-card p-10 flex flex-col items-center isometric-hover">
            ...
            <Link href="/quote?category=nursery" className="w-full py-4 bg-[#A3D5D3] text-white rounded-full font-bold text-lg hover:bg-[#8ebfb7] transition-all shadow-md text-center">
              View Nursery
            </Link>
          </div>
          <div className="feature-card glass-card p-10 flex flex-col items-center isometric-hover">
            ...
            <Link href="/quote?category=safety" className="w-full py-4 bg-[var(--primary)] text-white rounded-full font-bold text-lg hover:bg-[var(--primary-hover)] transition-all shadow-md text-center">
              View Safety
            </Link>
          </div>
        </div>
